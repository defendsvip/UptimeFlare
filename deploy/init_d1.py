...
if not r['success']:
    ...
    if r['errors'][0]['code'] == 7502:
        ...
        print("Please report this issue at https://github.com/allovend/UptimeFlare/issues.")
        exit(1)
else:
...
if d1_id == '':
    print("D1 database not found after creation. Please report this issue at https://github.com/allovend/UptimeFlare/issues.")
