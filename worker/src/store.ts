  ...
  uncompact(): MonitorState {
    ...
    Object.keys(this.data.incident).forEach((monitorId) => {
      ...
      if (
        ...
        throw new Error(
          'Inconsistent incident data lengths, please report an issue at https://github.com/allovend/UptimeFlare'
        )
      }
    ...
    Object.keys(this.data.latency).forEach((monitorId) => {
      ...
      if (timeArr.length !== pingArr.length || timeArr.length !== locUncompacted.length) {
        throw new Error(
          'Inconsistent latency data lengths, please report an issue at https://github.com/allovend/UptimeFlare.'
        )
      }
